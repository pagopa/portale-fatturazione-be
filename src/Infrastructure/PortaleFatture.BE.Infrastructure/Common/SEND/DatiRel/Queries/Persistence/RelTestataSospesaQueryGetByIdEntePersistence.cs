...
public class RelTestataSospesaQueryGetByIdEntePersistence(RelTestataSospesaQueryGetByIdEnte command) : DapperBase, IQuery<RelTestataSospesaDto?>
{
    private readonly RelTestataSospesaQueryGetByIdEnte _command = command;
    ...
    private static readonly string _orderBy = RelTestataSospesaSQLBuilder.OrderBy();
