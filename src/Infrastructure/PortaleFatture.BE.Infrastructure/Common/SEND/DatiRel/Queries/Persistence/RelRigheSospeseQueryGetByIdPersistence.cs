...
public class RelRigheSospeseQueryGetByIdPersistence(RelRigheSospeseQueryGetById command) : DapperBase, IQuery<IEnumerable<RigheRelDto>?>
{
    private readonly RelRigheSospeseQueryGetById _command = command;
    private static readonly string _sqlSelectAll = RelRigheSospeseSQLBuilder.SelectAll();
