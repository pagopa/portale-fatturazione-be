...
public class DocumentBuilder : IDocumentBuilder
{
    ...
    private static string _fileDettaglioFatturaSospesaPac = $"pac_fattura_sospesa_singola V2.html";
    private static string _fileDettaglioFatturaSospesaPal = $"pal_fattura_sospesa_singola V2.html";
    private static string _fileDettaglioFatturaEmessaPac = $"pac_fattura_emessa_singola V2.html";
    private static string _fileDettaglioFatturaEmessaPal = $"pal_fattura_emessa_singola V2.html";
    private static string _fileDettaglioFatturaEmessaPacMultipla = $"pac_fatture_emesse_multiple V2.html";
    private static string _fileDettaglioFatturaEmessaPalMultipla = $"pal_fatture_emesse_multiple V2.html";
