...
{
    public class FattureDettaglioEmessoAdminPersistence(FattureDocContabileDettaglioAdminEmessoQuery command) : DapperBase, IQuery<IEnumerable<FatturaDocContabileEmessoDettaglioDto>>
    {
