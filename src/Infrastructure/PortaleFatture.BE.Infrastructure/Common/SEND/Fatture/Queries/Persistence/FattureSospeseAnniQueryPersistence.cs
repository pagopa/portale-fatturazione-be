...
public class FattureSospeseAnniQueryPersistence(FattureSospeseAnniQuery command) : DapperBase, IQuery<IEnumerable<string>?>
{
    private readonly FattureSospeseAnniQuery _command = command;
    private static readonly string _sql = FattureQueryRicercaBuilder.SelectAnniSospese();
