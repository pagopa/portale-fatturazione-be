...
public class FatturePeriodoEnteQueryPersistence(FatturePeriodoEnteQuery command) : DapperBase, IQuery<IEnumerable<FatturePeriodoDto>>
{
    private readonly FatturePeriodoEnteQuery _command = command;
    private static readonly string _sql = FattureQueryRicercaBuilder.SelectPeriodoEnte(); 
