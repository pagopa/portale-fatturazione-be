...
public class FattureSospeseQueryRicercaPersistence(FattureSospeseQueryRicerca command) : DapperBase, IQuery<FattureListaDto?>
{
    private readonly FattureSospeseQueryRicerca _command = command;
    private static readonly string _sqlSelectAll = FattureQueryRicercaBuilder.SelectSospeseAll();
    private static readonly string _sqlSelectAllCancellate = FattureQueryRicercaBuilder.SelectSospeseCancellateAll();
