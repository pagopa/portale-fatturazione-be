...
";
    ...
    public static string SelectDettaglioSospesoEnte()
    {
        return @"
            ...
            tft.MeseRiferimento as Mese,
            tft.FkTipologiaFattura AS TipologiaFattura,
            tft.FkTipologiaFattura AS TipologiaFatturaSospesa,
    ...
    private static string _sqlSelectDettaglioEmessoPdf = @"
    SELECT [IdFattura]
      ,[RagioneSociale]
      ,[TipoDocumento]
      ,[IdEnte]
      ...
      ,[DataFatturaSospesa]
      ,[ProgressivoSospesa]
      ,[TipoDocumentoSospesa]
      ,[TotaleFatturaSospesaImponibile]
      ,[IdContrattoSospesa]
      ,[AnnoSospesa]
      ,[MeseSospesa]
      ,[TipologiaFatturaSospesa]
      ,[TotaleFatturaSospesa]
      ,[MetodoPagamentoSospesa]
      ,[CausaleFatturaSospesa]
      ,[SollecitoSospesa]
      ,[SplitPaymentSospesa]
      ,[DataDocumentoSospeso]
      ,[CodiceCommessaSospesa]
      ,[NumItemSospesa]
      ,[FatturaInviataSospesa]
      ,[SemestreSospesa]
      ,[FlagFatturataSospesa]
      ,[RelTotaleAnalogicoSospeso]
      ,[RelTotaleDigitaleSospeso]
      ,[RelTotaleNotificheAnalogicheSospeso]
      ,[RelTotaleNotificheDigitaliSospeso]
      ,[RelTotaleNotificheSospeso]
      ,[RelTotaleSospeso]
      ,[RelTotaleIvatoAnalogicoSospeso]
      ,[RelTotaleIvatoDigitaleSospeso]
      ,[RelTotaleIvatoSospeso]
      ,[CaricataSospeso]
      ,[RelFatturataSospeso]
      ,[Iva]
