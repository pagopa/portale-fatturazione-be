...
public class GestioneFattureQueryHandler(
IFattureDbContextFactory factory,
IStringLocalizer<Localization> localizer,
ILogger<GestioneFattureQueryHandler> logger) : IRequestHandler<GestioneFattureQuery, GestioneFattureListDto?>
{
    private readonly IFattureDbContextFactory _factory = factory;
    private readonly ILogger<GestioneFattureQueryHandler> _logger = logger;
