...
public class ContestazioneUpdateConsolidatoreCommandPersistence(ContestazioneUpdateConsolidatoreCommand command, IStringLocalizer<Localization> localizer) : DapperBase, ICommand<int>
{
    public bool RequiresTransaction => false;
    private readonly ContestazioneUpdateConsolidatoreCommand _command = command;
    IStringLocalizer<Localization> _localizer = localizer;

    private static readonly string _sqlUpdate = @"
UPDATE [schema][Contestazioni]
   SET [NoteConsolidatore] = @NoteConsolidatore
      ,[DataInserimentoConsolidatore] = @DataInserimentoConsolidatore
      ,[DataModificaConsolidatore] = @DataModificaConsolidatore  
