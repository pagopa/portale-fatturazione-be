...
internal class CreateRelRigheHandler
{
    [Function("CreateRelRigheHandler")]
    public async Task<HttpResponseData> CreateRelRigheOrchestration(
    ...
    [DurableClient] DurableTaskClient client)
    {
        ...
        var instanceId = await client.ScheduleNewOrchestrationInstanceAsync("CreateRelRigheOrchestrator", data);
        var payload = new
        {
